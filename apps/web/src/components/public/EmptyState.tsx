export function EmptyState(props: { title: string; body: string; tone?: 'neutral' | 'scanning' }) {
  const tone = props.tone ?? 'neutral';
  const badge = tone === 'scanning' ? 'bg-blue-50 text-blue-700 border-blue-200' : 'bg-slate-100 text-slate-600 border-slate-200';
